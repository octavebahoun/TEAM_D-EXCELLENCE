    ...
    <section className="testimonials-section">
      <div className="testimonials-container">
        ...
        <div className="testimonial-card">
          ...
          <motion.div className="testimonial-image-wrap" {...(reduce ? { initial: { opacity: 1, rotate: 0, scale: 1 }, whileInView: { opacity: 1, rotate: 0, scale: 1 } } : { initial: { opacity: 0, rotate: 5, scale: 0.9, filter: "blur(20px)" }, whileInView: { opacity: 1, rotate: 3, scale: 1, filter: "blur(0px)" }, transition: { duration: 1, ease: [0.22, 1, 0.36, 1] } })}>
            <img
